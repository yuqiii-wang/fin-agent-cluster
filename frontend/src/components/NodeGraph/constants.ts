...
export const INNER_STEP = 64;       // horizontal spacing between inner slots
export const INNER_VERT_STEP = 52;  // vertical spacing between parallel nodes in the same slot
export const INNER_RADIUS = 14;
export const NODE_RADIUS = 22;
export const SUBGRAPH_RADIUS = 36;
