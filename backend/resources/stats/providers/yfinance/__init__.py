...
Exports
-------
fetch         -- async download + transform into generic StatsRecord.
fetch_futures -- async download + transform into futures-prefixed StatsRecord.
fetch_options -- async download + transform into options StatsRecord.
...
from backend.resources.stats.providers.yfinance.fetch_futures import fetch as fetch_futures
...
__all__ = ["fetch", "fetch_futures", "fetch_options", "transform", "period_args"]
