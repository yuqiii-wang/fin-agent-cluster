...
from backend.resources.stats.providers.errors import STATS_PROVIDER_ERROR, STATS_YFINANCE_EMPTY
...
async def fetch(symbol: str, period: str) -> StatsRecord:
    ...
    Raises:
        ValueError: Propagated from :func:`~.transformer.transform` when
                    ...
                    :data:`~backend.resources.stats.providers.errors.STATS_YFINANCE_EMPTY`.
    """
