"""SQLAlchemy ORM models for fin_agents schema — user queries, checkpoints, node executions."""
...
class ExternalResource(Base):
    """Cached external downloads (files, images) related to a user query."""

    __tablename__ = "external_resources"
    __table_args__ = (
        Index("fin_agents_external_resources_thread_id_idx", "thread_id"),
        Index("fin_agents_external_resources_node_name_idx", "node_name"),
        {"schema": "fin_agents"},
    )
